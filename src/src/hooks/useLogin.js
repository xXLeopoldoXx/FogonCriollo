// ============================================================
// El Fogón Criollo – useLogin Hook
// Separa la lógica de login de los componentes de UI
// ============================================================
...
export function useLogin() {
  ...
  async function handleLogin({ username, password, rol }) {
    ...
    try {
      ...
      storeSession(data);           // guarda token + usuario en localStorage
      signIn(data);                 // actualiza contexto global
