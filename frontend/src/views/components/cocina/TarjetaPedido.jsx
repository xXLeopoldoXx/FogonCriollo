  ...
  return (
    ...
    >
      ...
      <p className={styles.mesero}>
        <User size={14} className={styles.meseroIcon} /> {pedido.mesero}
      </p>
        ...
        {items.map((item, i) => (
          <li key={i} className={styles.item}>
            ...
            <div className={styles.itemData}>
              ...
              {item.nota && (
                <span className={styles.itemNota}><MessageSquare size={12} /> {item.nota}</span>
              )}
            </div>
          </li>
        ))}
      ...
      {urg === 'alta' && (
        <div className={styles.urgAlert}>
          <AlertTriangle size={14} /> Pedido con {Math.floor(seg / 60)} minutos de espera
        </div>
      )}
    </div>
  );
